...
CREATE TABLE MEMBER(
    ...
    BIRTHDATE DATE,
    GENDER VARCHAR2(10) NOT NULL CHECK(GENDER IN('F','M','I')),
    PHONE VARCHAR2(30),
    ADDRESS VARCHAR2(50),
...
INSERT INTO MEMBER VALUES('admin','admin','관리자','도토리지키미',TO_DATE('210509','RRMMDD'),'I','01012345678','서울특별시 강남구',10000000,SYSDATE);
